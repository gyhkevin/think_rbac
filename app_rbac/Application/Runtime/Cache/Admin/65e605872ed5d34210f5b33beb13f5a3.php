	...
	<center>
		<table width=90% cellpadding="5" cellspacing="3">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<?php if(is_array($vo["role"])): $i = 0; $__LIST__ = $vo["role"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><span style="color:#999"><?php echo ($role); ?></span>
							&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
					</td>
					<td>
						<a href="<?php echo U('User/del',array('id'=>$vo['id']));?>">删除</a>
						<a href="<?php echo U('User/edit',array('id'=>$vo['id']));?>">修改</a>
						<a href="<?php echo U('User/rolelist',array('id'=>$vo['id']));?>">分配角色</a>
					</td>
